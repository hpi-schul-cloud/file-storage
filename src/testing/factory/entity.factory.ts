...
export class EntityFactory<T extends U, U extends object, I = any, C = U, P = DeepPartial<U>> {
	...
	protected clone<F extends EntityFactory<T, U, I, C, P>>(this: F, propsFactory: Factory<U, I, C, P>): F {
		const copy = new (this.constructor as new (EntityClass: new () => T, propsFactory: Factory<U, I, C, P>) => F)(
			this.EntityClass,
			propsFactory
		);
