...
export const AuthorizationApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		 ...
		 */
		authorizationReferenceControllerAuthorizeByReference: async (
...
export const AuthorizationApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async authorizationReferenceControllerAuthorizeByReference(
			authorizationBodyParams: AuthorizationBodyParams,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthorizedReponse>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.authorizationReferenceControllerAuthorizeByReference(
				authorizationBodyParams,
				options
			);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap['AuthorizationApi.authorizationReferenceControllerAuthorizeByReference']?.[
...
export const AuthorizationApiFactory = function (
	...
	return {
		...
		authorizationReferenceControllerAuthorizeByReference(
			authorizationBodyParams: AuthorizationBodyParams,
			options?: any
		): AxiosPromise<AuthorizedReponse> {
			return localVarFp
				.authorizationReferenceControllerAuthorizeByReference(authorizationBodyParams, options)
...
export class AuthorizationApi extends BaseAPI implements AuthorizationApiInterface {
	 ...
	 */
	public authorizationReferenceControllerAuthorizeByReference(
		authorizationBodyParams: AuthorizationBodyParams,
		options?: RawAxiosRequestConfig
	) {
